...
export const faqIndex: FaqIndexEntry[] = [
  ...
  },
  {
    ...
    "sourceTitle": "Devolução de Produtos ao Fornecedor",
    "to": "/docs/fiscal/devolucao-de-produtos-ao-fornecedor",
    "question": "Posso gerar a devolução direto da nota de entrada?",
    "answerText": "Sim. O sistema possui a opção Devolver NF para usar a nota inteira como base.",
    "normalizedQuestion": "posso gerar a devolucao direto da nota de entrada?",
    "normalizedAnswer": "sim. o sistema possui a opcao devolver nf para usar a nota inteira como base.",
    "normalizedSourceTitle": "devolucao de produtos ao fornecedor"
  },
  {
    "category": "fiscal",
    "categoryLabel": "Fiscal",
    "sourceTitle": "Devolução de Produtos ao Fornecedor",
    "to": "/docs/fiscal/devolucao-de-produtos-ao-fornecedor",
    "question": "Posso devolver somente um produto da nota?",
    "answerText": "Sim. Nos detalhes da nota de entrada existe o botão Devolver no item.",
    "normalizedQuestion": "posso devolver somente um produto da nota?",
    "normalizedAnswer": "sim. nos detalhes da nota de entrada existe o botao devolver no item.",
    "normalizedSourceTitle": "devolucao de produtos ao fornecedor"
  },
  {
    "category": "fiscal",
    ...
    "sourceTitle": "Devolução de Produtos ao Fornecedor",
    "to": "/docs/fiscal/devolucao-de-produtos-ao-fornecedor",
    "question": "O fornecedor vira o destinatário da devolução?",
    "answerText": "Sim. No fluxo encontrado no sistema, o fornecedor da nota de entrada é usado como destinatário da devolução.",
    "normalizedQuestion": "o fornecedor vira o destinatario da devolucao?",
    "normalizedAnswer": "sim. no fluxo encontrado no sistema, o fornecedor da nota de entrada e usado como destinatario da devolucao.",
    "normalizedSourceTitle": "devolucao de produtos ao fornecedor"
  },
  {
    "category": "fiscal",
    ...
    "sourceTitle": "Devolução de Produtos ao Fornecedor",
    "to": "/docs/fiscal/devolucao-de-produtos-ao-fornecedor",
    "question": "Preciso informar a chave da nota original?",
    "answerText": "Em operações de devolução, a tela possui a etapa de documento referenciado. Quando a devolução parte da nota de entrada, a chave pode vir carregada automaticamente.",
    "normalizedQuestion": "preciso informar a chave da nota original?",
    "normalizedAnswer": "em operacoes de devolucao, a tela possui a etapa de documento referenciado. quando a devolucao parte da nota de entrada, a chave pode vir carregada automaticamente.",
    "normalizedSourceTitle": "devolucao de produtos ao fornecedor"
  },
  {
    "category": "fiscal",
    ...
    "sourceTitle": "Devolução de Produtos ao Fornecedor",
    "to": "/docs/fiscal/devolucao-de-produtos-ao-fornecedor",
    "question": "Posso salvar sem transmitir?",
    "answerText": "Sim. A tela oferece a opção Apenas salvar .",
    "normalizedQuestion": "posso salvar sem transmitir?",
  ...
  },
  {
    ...
    "answerText": "Sim. Depois do salvamento, a nota pode ser acompanhada e transmitida pela lista de notas fiscais.",
    "normalizedQuestion": "posso transmitir depois?",
    "normalizedAnswer": "sim. depois do salvamento, a nota pode ser acompanhada e transmitida pela lista de notas fiscais.",
    "normalizedSourceTitle": "devolucao de produtos ao fornecedor"
  },
  {
    "category": "fiscal",
  ...
  },
  {
    ...
    "sourceTitle": "Meu Perfil",
    "to": "/docs/configuracoes/meu-perfil",
    "question": "Posso alterar meu e-mail nessa tela?",
    "answerText": "Na análise feita, o e mail aparece apenas para consulta.",
    "normalizedQuestion": "posso alterar meu e-mail nessa tela?",
    "normalizedAnswer": "na analise feita, o e mail aparece apenas para consulta.",
    "normalizedSourceTitle": "meu perfil"
  },
  {
    "category": "configuracoes",
    "categoryLabel": "Configuracoes",
    "sourceTitle": "Meu Perfil",
    "to": "/docs/configuracoes/meu-perfil",
    "question": "O que é o nome de identificação do contrato?",
    "answerText": "É o nome usado para identificar a conta ou a empresa dentro do sistema.",
    "normalizedQuestion": "o que e o nome de identificacao do contrato?",
    "normalizedAnswer": "e o nome usado para identificar a conta ou a empresa dentro do sistema.",
    "normalizedSourceTitle": "meu perfil"
  },
  {
    "category": "configuracoes",
    ...
    "answerText": "Sim. A tela permite alterar o campo Seu nome de usuário (colaborador) .",
    "normalizedQuestion": "posso mudar meu nome de usuario?",
    "normalizedAnswer": "sim. a tela permite alterar o campo seu nome de usuario (colaborador) .",
    "normalizedSourceTitle": "meu perfil"
  },
  {
    "category": "configuracoes",
    "categoryLabel": "Configuracoes",
    "sourceTitle": "Meu Plano",
    "to": "/docs/configuracoes/meu-plano",
    "question": "Posso alterar meus dados por essa tela?",
    "answerText": "Você pode consultar os dados nessa tela. Para alterar, o sistema oferece um atalho para Meu perfil .",
    "normalizedQuestion": "posso alterar meus dados por essa tela?",
    "normalizedAnswer": "voce pode consultar os dados nessa tela. para alterar, o sistema oferece um atalho para meu perfil .",
    "normalizedSourceTitle": "meu plano"
  },
  {
    "category": "configuracoes",
    "categoryLabel": "Configuracoes",
    "sourceTitle": "Meu Plano",
    "to": "/docs/configuracoes/meu-plano",
    "question": "Como sei qual plano está ativo?",
    "answerText": "O nome do plano aparece em destaque na aba Meus Dados .",
    "normalizedQuestion": "como sei qual plano esta ativo?",
    "normalizedAnswer": "o nome do plano aparece em destaque na aba meus dados .",
    "normalizedSourceTitle": "meu plano"
  },
  {
    "category": "configuracoes",
    ...
    "sourceTitle": "Meu Plano",
    "to": "/docs/configuracoes/meu-plano",
    "question": "Posso pagar a fatura por essa tela?",
    "answerText": "Sim. Quando a fatura estiver em aberto e houver link disponível, aparece o botão Pagar fatura .",
    "normalizedQuestion": "posso pagar a fatura por essa tela?",
    "normalizedAnswer": "sim. quando a fatura estiver em aberto e houver link disponivel, aparece o botao pagar fatura .",
    "normalizedSourceTitle": "meu plano"
  },
  {
    "category": "configuracoes",
    ...
    "sourceTitle": "Meu Plano",
    "to": "/docs/configuracoes/meu-plano",
    "question": "O que significa um recurso aparecer como não liberado?",
    "answerText": "Significa que esse recurso não está disponível no plano atual.",
    "normalizedQuestion": "o que significa um recurso aparecer como nao liberado?",
    "normalizedAnswer": "significa que esse recurso nao esta disponivel no plano atual.",
    "normalizedSourceTitle": "meu plano"
  },
  {
    "category": "configuracoes",
    "categoryLabel": "Configuracoes",
    "sourceTitle": "Minhas Empresas",
    "to": "/docs/configuracoes/minhas-empresas",
    "question": "Posso cadastrar uma nova empresa por essa tela?",
    "answerText": "Na interface analisada, o fluxo visível para o usuário é de consulta, detalhes, alteração e certificado digital. Não foi encontrado um botão normal de cadastro nessa tela.",
    "normalizedQuestion": "posso cadastrar uma nova empresa por essa tela?",
    "normalizedAnswer": "na interface analisada, o fluxo visivel para o usuario e de consulta, detalhes, alteracao e certificado digital. nao foi encontrado um botao normal de cadastro nessa tela.",
    "normalizedSourceTitle": "minhas empresas"
  },
  {
    "category": "configuracoes",
    "categoryLabel": "Configuracoes",
    "sourceTitle": "Minhas Empresas",
    "to": "/docs/configuracoes/minhas-empresas",
    "question": "Posso alterar o CPF ou CNPJ da empresa?",
    "answerText": "Não. Na tela analisada, esse campo aparece bloqueado para edição.",
    "normalizedQuestion": "posso alterar o cpf ou cnpj da empresa?",
    "normalizedAnswer": "nao. na tela analisada, esse campo aparece bloqueado para edicao.",
    "normalizedSourceTitle": "minhas empresas"
  },
  {
    "category": "configuracoes",
  ...
  },
  {
    ...
    "sourceTitle": "Perfis de Usuários",
    "to": "/docs/configuracoes/usuarios-e-permissoes",
    "question": "Posso alterar um perfil depois de criado?",
    "answerText": "Sim. O perfil pode ser alterado sempre que necessário.",
    "normalizedQuestion": "posso alterar um perfil depois de criado?",
    "normalizedAnswer": "sim. o perfil pode ser alterado sempre que necessario.",
    "normalizedSourceTitle": "perfis de usuarios"
  }
];
